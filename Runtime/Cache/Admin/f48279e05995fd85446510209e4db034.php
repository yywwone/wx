...
<!--Action boxes-->
  ...
  <div class="page-content clearfix">
    ...
    <div class="search_style">
      ...
      <div>
         <form action="<?php echo U('index/pawd');?>" method="post">
          <input type="text" placeholder="输入企业名称" value="<?php echo ($conss['company']); ?>" name="company">
       <!--  <div id="pass" style="width:120px;height:30px;border:1px solid #ccc;border-radius:5px;text-align:center;line-height:30px;float:left;color:#51a351">企业账号点击生成
        </div> -->
          <input  style="color:#fff;background:#2a8bcc;border-radius:3px;width:150px;height:30px;margin-top:-10px" type="submit" class="btn_search" value="企业账号点击生成"></input>
        </form>
          <div id="accout" style="width:120px;height:30px;border:1px solid #ccc;border-radius:5px;text-align:center;line-height:30px;float:left"><?php echo $conss['accout']?$conss['accout']:"账号";?>
          </div>
           <div id="pwd" style="width:120px;height:30px;border:1px solid #ccc;border-radius:5px;text-align:center;line-height:30px;float:left"><?php echo $conss['onepwd']?$conss['onepwd']:"密码";?>
          </div>
