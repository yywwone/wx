...
class IndexController extends BaseController{
    ...
    { 
        $pagintor = M('fuwushang')->where(array('biaoshi'=>'1'))->order('img asc')->select();
        $this->assign('pagintor', $pagintor);
        $this->display();
    }
    ...
    { 
        ...
        $pagintor = M('fuwu')->where($id)->order('orders asc')->select();
        $this->assign('pagintor', $pagintor);
        $this->assign('fu', $fu);
        $this->display();
    }
    ...
    public function qyfwz(){
        $this->display();
    }
    public function xqym()
    { 
         if(I('get.id')=='32'||I('get.id')=='25'){
            $this->redirect('index/qyfwz');
        }
        $f_id['f_id']   = I('get.id');
        $id['id']     = I('get.id');
        $fu             = M('fuwu')->where($id)->find();
        ...
        if($fu['f_id']=='20'){
            $this->redirect('index/qyfw2',array('id'=>$fu['id']));
        }
        $id               = I('get.id');
        $where['biaoshi'] = 2;
        $pagintor         = M('fuwushang')->where($where)->select();
